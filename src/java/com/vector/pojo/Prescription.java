...
public class Prescription implements java.io.Serializable {
    ...
    public Prescription(int prescriptionId, Patient patient, MedicalRecord medicalRecord, String prescriptionContent, Date prescriptionDate, String prescriptionPrecautions) {
