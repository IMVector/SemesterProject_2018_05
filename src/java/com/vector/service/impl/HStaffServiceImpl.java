...
public class HStaffServiceImpl implements HStaffService {
    ...
    @Transactional
    @Override
    public List<Staff> getStaffByName(Serializable titleName, Serializable currentPage) {
        return staffDao.getStaffByName(titleName, currentPage);
    }
    ...
    public boolean updateOne(Staff object) {
        return staffDao.updateOne(object);
    }
